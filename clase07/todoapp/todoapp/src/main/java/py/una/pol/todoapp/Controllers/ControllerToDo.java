...
public class ControllerToDo {
    ...
    @PostMapping
    public ResponseEntity<ToDo> crearToDo(Authentication authentication, @RequestBody ToDoDTO todoDto){
        return toDoService.crearToDo(todoDto, authentication.getName());
    }
